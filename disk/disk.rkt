...
(library
 ...
 (define (encode-fixed-natural! blck offs size nmbr)
   ;(dirty! blck #t)
   (cond ((and (= size 1) (> nmbr 255)) (display "error") (newline) (error "size is to big"))
         ((and (= size 1) (<= nmbr 255)) (encode-byte! blck offs nmbr) (dirty! blck #t))
         (else (encode-fixed-natural! blck offs (- size 1) (div nmbr 256)) (encode-byte! blck (+ (- size 1) offs) (mod nmbr 256)))
         )
 ...
 (define (decode-fixed-natural blck offs size)
   (if (> size 0)
      (+ (decode-fixed-natural blck (+ 1 offs) (- size 1)) (* (expt 256 (- size 1)) (decode-byte blck offs)))
      0
      )
